...
def Add_Custom_Menu_Items_Vray_Plugin_Load(plugin):
	if plugin == "vrayformaya":
		if cmds.menu("vrayMenuCreateItem",query=True,exists=True):
			...
			cmds.menuItem("vrayMenuCreateOpenSubdivisionAttributesItem",command='[cmds.vray("addAttributesFromGroup",mesh,"vray_opensubdiv",1) for mesh in cmds.ls(sl=True,dagObjects=True,shapes=True,long=True,flatten=True,type="mesh")]',parent="AWvrayAttributesMakeMenu",label="Add Open Subdivision", annotation="Add A Vray Open Subdivision Attribute To All The Selected Mesh Nodes")
			cmds.menuItem("vrayMenuRemoveOpenSubdivisionAttributesItem",command='[cmds.vray("addAttributesFromGroup",mesh,"vray_opensubdiv",0) for mesh in cmds.ls(sl=True,dagObjects=True,shapes=True,long=True,flatten=True,type="mesh")]',parent="AWvrayAttributesMakeMenu",label="Remove Open Subdivision", annotation="Remove A Vray Open Subdivision Attribute From All The Selected Mesh Nodes")
...
callbackId4 = Maya_Callback_Builders.create_Scene_Message_Callback(Maya_Callback_Builders.Scene_Message_Before_Flags.CreateReference, kill_HyperShadePanel, None)
