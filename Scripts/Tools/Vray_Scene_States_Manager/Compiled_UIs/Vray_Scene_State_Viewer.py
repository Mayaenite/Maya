...
#
# Created: Thu Dec 10 07:49:43 2015
...
class Ui_Vray_Scene_States_Viewer(object):
	def setupUi(self, Vray_Scene_States_Viewer):
		...
		Vray_Scene_States_Viewer.resize(475, 337)
		...
		sizePolicy.setHorizontalStretch(0)
		sizePolicy.setVerticalStretch(0)
		sizePolicy.setHeightForWidth(self.Asset_Grid_widget.sizePolicy().hasHeightForWidth())
		self.Asset_Grid_widget.setSizePolicy(sizePolicy)
